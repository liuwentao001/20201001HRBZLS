CREATE OR REPLACE PROCEDURE HRBZLS."SP_CHARGEINVSEARCHHP_NEWHZBAK" (
  ...
  begin
    ...
    open o_base for
           ...
           '币  '|| tools.fuppernumber(sum(pdje)+sum(pdznj)+max(PSAVINGBQ ))                     C10             ,--合计金额大写            C10
            '￥'||tools.fformatnum(sum(pdje)+sum(pdznj)+max(PSAVINGBQ ) ,2)                     C11             ,--合计金额                C11
            ...
            '暂无启用'                                                         C36             ,--抄表月份                C36
            '应收现金 '||fGetRecZnjMoney_gt(pid)                 合计应收1                                                  ,--合计应收1                            C37
            '暂无启用'                                                         C38             ,--收费方式                C38
            '暂无启用'                                                         C39             ,--水费明细3               C39
           ''                                                        C40             ,--预存发生明细            C40
           ''                                  C41             ,--应收金额大写           C41
