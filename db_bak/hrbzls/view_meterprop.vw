CREATE OR REPLACE FORCE VIEW HRBZLS.VIEW_METERPROP AS
SELECT fgetsysmanaframe(a.mismfid) AS 营业所, --营业所
       ...
       and a.micid = d.mdmid
       AND C.ciid = A.micid
       AND (A.MIIFTAX='N' OR A.MIIFTAX IS NULL )
       and a.mistatus not in ('7','19','28','31','32','34','33')
       and a.MICHARGETYPE='X'
;
