CREATE OR REPLACE FORCE VIEW HRBZLS.MV_RECLIST_CHARGE_RDID AS
SELECT /*+ INDEX(C  IDX_RDID)*/
 COUNT(*) C,
 COUNT(RDSL) RDSL_C,
 COUNT(RDJE) RDJE_C,
 COUNT(RDDJ) RDDJ_C,
 ...
 SUM(DECODE(RDPIID, '11', RDJE, 0)) CHARGE11, --  代收费9
 SUM(DECODE(RDPIID, '12', RDJE, 0)) CHARGE12, --  代收费9
 SUM(CASE
