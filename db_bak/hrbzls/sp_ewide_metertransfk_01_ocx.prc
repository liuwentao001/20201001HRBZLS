CREATE OR REPLACE PROCEDURE HRBZLS."SP_EWIDE_METERTRANSFK_01_OCX" (p_modelno in varchar2) is
...
select  CINAME                                                              c1, --ÓÃ»§Ãû³Æ
           ...
           MIRCODE                                                                         c13,-- ³­±íÐÐ¶È
           null                                                                         c14,  --³­±íÔ±
           decode(pt.c2,'1','¡Ì1',null)                               c15, --¸´¹©Ë®Çé¿ö£º1¡¢¿ª·§
           decode(pt.c2,'2','¡Ì2',null)                               c16, --¸´¹©Ë®Çé¿ö£º2¡¢Ô­Ë®±í
           decode(pt.c2,'3','¡Ì3',null)                               c17, --¸´¹©Ë®Çé¿ö£º3¡¢»»±í
           pt.c3                              c18, --¾­°ìÈË
           fgetoperdept(pt.c3)                               c19, --¸´¹©Ë®²¿ÃÅ
           to_char(sysdate,'yyyy')                               c20, --Äê
           to_char(sysdate,'MM')  c21,  --ÔÂ
           to_char(sysdate,'dd') c22,  --ÈÕ
           to_char(sysdate,'hh24') c23,  --Ê±
           to_char(sysdate,'mi') c24,  --·Ö
           to_char(sysdate,'ss') c25,  --Ãë
           null c26,  --Ô¤Áô×Ö¶Î6
           null c27,  --Ô¤Áô×Ö¶Î7
           null c28,  --Ô¤Áô×Ö¶Î8
           null c29,  --Ô¤Áô×Ö¶Î9
