CREATE OR REPLACE FUNCTION HRBZLS."FGETPRICETEXT_GTMX" (p_plid in varchar2 ) --应收流水
  RETURN VARCHAR2
AS
...
BEGIN
      select sum(pdznj) pdznj into v_znj from payment,paidlist,paiddetail where plid=p_plid  and pid = plpid and plid = pdid;
