CREATE OR REPLACE PROCEDURE HRBZLS."SP_FCHARGEINVSEARCH_FP_OCX" (
...
--分票(销帐)
          ...
          replace(   tools.fuppernumber(sum(pdje)+sum(pdznj)+max(PLSAVINGBQ ) )   ,'-.','-0.')            C10             ,--合计金额大写            C10
           ...
           F_chargeinvsearch_recmx_ocx1(plid,null,'1',1)                C12             ,--水费明细1               C12
           '                                '                           C13             ,--水费明细2               C13
        ...
        F_chargeinvsearch_recmx_ocx1(plid,null,'1',2)                                                         C49            ,--用户预留字段9           C49
        F_chargeinvsearch_recmx_ocx1(plid,null,'1',3)                                                         C50             ,--用户预留字段10          C50
        F_chargeinvsearch_recmx_ocx1(plid,null,'1',4)                                                          C51             ,--应收账流水号            C51
        F_chargeinvsearch_recmx_ocx1(plid,null,'1',5)                            C52             ,--费用项目                C52
           '                                '                                                                C53             ,--打印员编号              C53
          '                                '                                                       C54             ,--收费员              C54
