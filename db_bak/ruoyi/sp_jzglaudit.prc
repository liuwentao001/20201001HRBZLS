...
for jzgl in (select * from request_jzgl where enabled=5 and workid= P_WORKID) loop
		...
		-----bs_meterinfo 
		if v_flagm=0 then 
			insert into bs_meterinfo(miid, miadr, micode, mismfid, mibfid, mirorder, mipid, miclass, mirtid, mistid, mipfid, mistatus, miside, miinscode, miinsdate, milh, midyh, mimph, mixqm, mijd, miyl13, dqsfh, dqgfh, micardno)
			select miid, miadr, ciid, resmfid, mibfid, mirorder, mipid, miclass, mirtid, mistid, mipfid, mistatus, miside, miinscode, miinsdate, milh, midyh, mimph, mixqm, mijd, miyl13, dqsfh, dqgfh, micardno from request_jzgl  where reno = jzgl.reno;
		end if;
