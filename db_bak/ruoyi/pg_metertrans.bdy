CREATE OR REPLACE PACKAGE BODY PG_METERTRANS IS
  ...
  BEGIN
    ...
    FOR MD IN (SELECT * FROM GD_METERTGLDT WHERE MTDNO = P_MTHNO) LOOP
  ...
  BEGIN
    ...
    ELSIF P_TYPE = BT故障换表 THEN
     ...
     WHERE MRMID=P_MD.MTDMID AND MRREADOK='N' 
